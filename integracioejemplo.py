...
# Calculamos el error absoluto entre el valor real de la integral y el calculado por los diferentes mtodos.
...
def integrate(func, a, b, n):
    ...
    #en la lista "errors" guaramos el error de nuestro clculo con respecto al valor exacto de la integral.
    errors = [np.log10(error(exact_value, item[1])) for item in results]
    
    print results, item[1], item[0]
...
#Ahora inplementaremos la funcin "integrate" 20 veces recorriendo 6 ordenes de magnitud.
for n in numbers:
